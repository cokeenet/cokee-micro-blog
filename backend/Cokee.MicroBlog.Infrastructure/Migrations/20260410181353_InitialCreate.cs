        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetweetOriginalPostId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Posts_Posts_RetweetOriginalPostId",
                        column: x => x.RetweetOriginalPostId,
                        principalTable: "Posts",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interactions_UserId_PostId_Type",
                table: "Interactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_RetweetOriginalPostId",
                table: "Posts",
                column: "RetweetOriginalPostId");
